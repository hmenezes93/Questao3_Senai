...
int main() {
	...
	cout << "=============================" << endl;
	cout << " Decifra mensagem 128-bit AES " << endl;
	cout << "=============================" << endl;
	...
	if (infile.is_open())
	{
		...
		cout << "Mensagem criptografada lida do arquivo message.aes" << endl;
		infile.close();
	}
	...
	cout << "Mensagem dcifrada (em hex):" << endl;
	for (int i = 0; i < messageLen; i++) {
		cout << hex << (int)decryptedMessage[i];
		cout << " ";
	}
	cout << endl;
	cout << "Mensagem decifrada (texto): ";
	for (int i = 0; i < messageLen; i++) {
